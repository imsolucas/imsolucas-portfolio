...
const AboutSection = (props) => {
  ...
  return (
    <Section mobileTop>
      ...
      <motion.p
        className="text-lg text-[#59331A] mt-4"
        initial={{
          opacity: 0,
          y: 25,
        }}
      ...
      >
        ...
        <br />
		I'm passionate about bringing the next young
        <br />
        generation into the world of technology.
      </motion.p>
      <motion.button
        onClick={() => setSection(3)}
        className={`bg-[#008000] text-[#F0F0F0] py-4 px-8
  ...
  return (
    <Section>
      <motion.div className="w-full" whileInView={"visible"}>
        ...
        <div>
          <h2 className="text-2xl md:text-4xl font-bold mt-10 text-white">
            Languages
          </h2>
...
const ContactSection = () => {
  const [state, handleSubmit] = useForm("mvgonqwq");
  return (
    <Section>
